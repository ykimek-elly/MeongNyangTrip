        ...
        <body class="bg-gray-100">
            <div class="mobile-container min-h-screen px-6 py-8 relative bg-white">
                <header class="flex items-center mb-10">
                    ...
                    <h1 class="text-lg font-bold ml-2">비밀번호 찾기</h1>
                </header>

                <form action="<c:url value='/findPwProcess' />" method="post" class="space-y-6">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">아이디 (이메일)</label>
